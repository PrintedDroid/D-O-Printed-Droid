...
struct Configuration {
  uint16_t magic = 0xD043;  // v3.4+ layout. Older v2.1/v3.x builds used 0xD042 with incompatible field order.
  ...
  float max_acceleration = 20.0;  // Reserved for EEPROM compatibility (not used in v3.4)
...
// ============================================================================
// End of D-O Universal Controller v3.4.0
// ============================================================================
