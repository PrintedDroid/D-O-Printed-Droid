 ...
 * VERSION: 3.2.2 (Critical Performance Fixes)
 * DATE:    November 2025
 *
 * DESCRIPTION:
 ...
 *   - PWM input on pins 2, 3 for drive (tank mixed)
 ...
 *   Pin 2: Drive Channel 1
 *   Pin 3: Drive Channel 2
...
// PWM Input (Mode 0)
const uint8_t PWM_DRIVE1_PIN = 2;
const uint8_t PWM_DRIVE2_PIN = 3;
...
// Servos
const uint8_t MAINBAR_SERVO_PIN = 4;
const uint8_t HEAD1_SERVO_PIN = 5;
const uint8_t HEAD2_SERVO_PIN = 6;
const uint8_t HEAD3_SERVO_PIN = 9;
...
void setup() {
  Serial.begin(9600);
  Serial.println(F("\n=== D-O Universal Controller v3.2.2 ==="));
...
void updateIMUReadings() {
  ...
  uint8_t accel_bytes = Wire.requestFrom(0x68, 6, true);
  ...
  Wire.write(0x43);
  Wire.endTransmission(false);
  uint8_t gyro_bytes = Wire.requestFrom(0x68, 6, true);
...
// ============================================================================
// End of D-O Universal Controller v3.2.2
// ============================================================================
